...
block_size = 128
USB_inst_list=[]
USB_inst_file = open('USB_process_inst_continuous_KITTI_03_relative' + '.txt','w+')
block_row_cnt = 0
block_col_cnt = 0
...
USB_inst_file.write('11' + '000100' + '00000000000000000011' + '0000' + '\n') #p_div + core div golden
...
#low
USB_inst_file.write('11' + '001011' + '000000000000000000001111' + '\n') #KEYPOINT_THRESHOLD
#mid
